...
A la recuperación de las instalaciones iniciadas hace seis meses, las empresas sumaron el inicio del proceso de intervención de pozos en los que se cambiaron varillas de producción y bomba. Con ello, se logró poner nuevamente en producción el primer pozo. Los desembolsos de más de $110 millones fueron impulsados por el programa de reintegro a la inversión Mendoza Activa.

“También se realizó un intenso trabajo en un estudio de integridad del ducto que une Vega Grande con las baterías de almacenamiento Tres Esquinas. El área está teniendo una muy buena productividad y se abren buenas perspectivas”, agregó Schilardi.
...
//    inicio: {
//        presidente: [
//            "President of VenOil Energía with 23 years of experience in managing gas and oil projects in different fields of Argentina.",
//            "He has held various technical, managerial, and executive positions in companies such as Repsol and YPF.",
//            "His last executive role was focused on the assets in the southern part of the Mendoza province. He received several recognitions from the senior management of both companies, acknowledging his excellent results.",
//            "Gustavo is an Electronic Engineer and completed his academic training through Executive Management (IAE) and Senior Management (UCA) programs. He has extensive experience in production, treatment, and transportation of gas & oil, project management, and negotiations with partners, unions, and government agencies.",
//            "He is a Co-founder of VenOil Energia. All of this makes Gustavo an expert in the management of Oil & Gas projects."
//        ],
//        valores: [
//            "Leadership in all phases of the project",
//            "Transparency in performance",
//            "Passion in every task and new challenge",
//            "Respect for communities and the environment",
//            "Excellence at all levels of the organization",
//            "Integrity as the foundation of all our decisions"
//        ],
//        campos: {
//            "manzano": "El Manzano Oeste, located in the Malargüe department, is one of VenOil Energía's most important assets in Mendoza. It was one of the first fields operated by VenOil, and from here, the business model the company implements today was developed. Recognized for the quality of its oil and its location in a region with a rich oil tradition, this field contributes significantly to the economic development of southern Mendoza. VenOil implements advanced extraction methods and maintains a strong commitment to local communities, ensuring that operations at El Manzano Oeste are an example of responsible and sustainable management, while driving the growth of Malargüe as a prominent oil hub.",
//            "piedrascoloradas": "The Piedras Coloradas field, located in the Mendoza province, is one of VenOil Energía's standout operations in the region. Recently acquired by the company, this field is recognized for its conventional oil production and is a key economic driver for the nearby communities. With the implementation of modern extraction techniques and management aligned with ISO 9001, 14001, and 45001 standards, VenOil ensures that the operations at Piedras Coloradas are sustainable and generate direct and indirect employment, strengthening the economy of Mendoza.",
//            "cacheuta": "Located in a strategic area of Mendoza, the Cacheuta field, recently acquired by VenOil Energía, is a historic milestone for the oil industry in the region and the country. This field was one of the first to be exploited on a large scale in Argentina, marking the beginning of an era of energy development in the national territory. Its legacy transcends generations, and today, thanks to the incorporation of modern technologies, it remains a key source of energy and employment, consolidating its role as a reference in Mendoza's oil history and the country.",
//            "chimenaike": "Chimen Aike, managed by VenOil Energía, is located near Río Gallegos and represents an important asset for the company and the province. This field has great potential for natural gas production and is being evaluated for the development of unconventional resources. The operation of Chimen Aike not only contributes to local economic growth but also positions Santa Cruz as a key energy hub for the future.",
//            "canadonsalto": "Operated by VenOil Energía, Cañadón Salto is a field located in one of the most remote areas of southern Santa Cruz. It is characterized by the extraction of light oil and natural gas, using secondary recovery technologies to optimize production. This field is essential for the province, as it generates economic resources, employment, and energy stability, consolidating VenOil's commitment to the sustainable development of the region.",
//            "maggie": "In the heart of the central oil corridor of Santa Cruz, Estancia La Maggie stands out as a strategic field for VenOil Energía. With mixed production of high-quality oil and natural gas, this field is an important source of resources for the province. Despite the logistical and climatic challenges of the region, VenOil has implemented effective solutions that maximize the potential of this asset, generating employment and contributing to the economic development of nearby communities.",
//            "condor": "Located near Río Gallegos, the El Cóndor field, operated by VenOil Energía, is a key piece in the Austral Basin. This field primarily produces natural gas, supplemented by oil reserves. Its importance lies in its ability to supply energy to the region, connecting its production to the San Martín Gas Pipeline. Thanks to treatment plant infrastructure and the use of modern technologies, El Cóndor not only generates employment and economic development but also ensures a reliable energy supply for Santa Cruz and beyond."
//        }
//    },
//    gestionintegrada: {
//        principios: [
//            "ISO 9001 - Quality Management: This standard ensures that our processes are designed to consistently meet customer expectations, improving efficiency and fostering continuous improvement.",
//            "ISO 14001 - Environmental Management: Committed to environmental care, we implement this standard to responsibly manage the environmental impacts of our activities, promoting sustainable and environmentally friendly practices.",
//            "ISO 45001 - Occupational Health and Safety Management: We guarantee the safety and well-being of our employees and collaborators through systems that identify, control, and reduce risks in the work environment.",
//            "We monitor every detail to ensure safety in all our operations."
//        ],
//        gestion: [
//            "We establish standards that protect our team, communities, and the environment.",
//            "We are committed to preventing risks through proactive and responsible management.",
//            "We optimize our processes to ensure safe and efficient operations.",
//            "We constantly innovate in technologies that prioritize safety in the field.",
//            "We lead by example, promoting a culture of safety in every project."
//        ]
//    }
//}
//
