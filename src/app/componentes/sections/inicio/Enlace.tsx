  ...
  return (
    <div>
      <section className="relative flex items-center justify-center bg-gradient-to-r from-verde to-azul text-white p-12 gap-16">
        ...
        <button className="text-xs font-semibold border-2 border-white rounded-full py-2 px-4 hover:bg-white hover:text-black transition duration-300 transform hover:scale-105 shadow-md">
          GESTIÓN INTEGRADA
        </button>
      </section>
